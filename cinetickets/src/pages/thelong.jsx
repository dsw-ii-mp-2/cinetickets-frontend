...
// Componente principal para The Long Game - MODERNIZADO
export default function TheLongGame() {
  ...
  const handleSeatConfirmation = (selectedSeats, paymentMethod) => {
    ...
    alert(`¡Compra exitosa!\n\nPelícula: THE LONG GAME\nHorario: ${selectedTime}\nAsientos: ${selectedSeats.join(', ')}\nTotal: $${totalAmount.toLocaleString('es-CO')}\nMétodo: ${paymentMethods[paymentMethod]}\n\n¡Disfruta de la función!`);
    setShowSeatModal(false);
    setSelectedTime(null);
  };

  // Datos de la película The Long Game
  const movieData = {
    title: "THE LONG GAME",
    originalTitle: "The Long Walk",
    country: "United States of America",
    director: "Francis Lawrence",
    actors: "Cooper Hoffman, David Jonsson, Garrett Wareing, Tut Nyuot, Charlie Plummer, Ben Wang, Roman Griffin Davis, Jordan Gonzalez, Josh Hamilton, Judy Greer, Mark Hamill",
    language: "Inglés",
    duration: "2h 15m",
    rating: "Mayores de 16 años",
    genres: ["Thriller", "Drama", "Suspenso", "Ciencia Ficción"],
    imageUrl: "/thelong.jpg",
    trailerUrl: "/Videos/thelong-trailer.mp4",
    posterUrl: "/thelong-poster.jpg",
    year: "2025"
  };

  // Todos los horarios en un solo array para facilitar la selección
  const allShowtimes = [
    "1:45 PM", "4:15 PM", "7:00 PM", "9:45 PM"
  ];
  ...
  const synopsis = [
    ...
    "En un futuro distópico, cien jóvenes participan en una competencia mortal conocida como 'The Long Walk', donde deben mantener un ritmo constante sin detenerse. Quien se detenga, recibe una advertencia. Tres advertencias y... desaparece. Solo uno puede sobrevivir en este juego brutal donde la resistencia física y mental se ponen a prueba al límite."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            THE LONG <span className="text-[#D4AF37]">GAME</span>
          </h1>
