...
// Componente principal para Una Batalla Tras Otra - MODERNIZADO
export default function UnaBatallaTrasOtra() {
  ...
  // Datos de la película Una Batalla Tras Otra
  const movieData = {
    title: "UNA BATALLA TRAS OTRA",
    originalTitle: "One Battle After Another",
    country: "United States of America",
    director: "Paul Thomas Anderson",
    actors: "Leonardo DiCaprio, Benicio Del Toro, Sean Penn",
    language: "Inglés",
    duration: "2h 41m",
    rating: "Mayores de 12 años",
    genres: ["Acción", "Crimen", "Drama", "Suspenso"],
    imageUrl: "/unabatallatrasotra.jpg",
    trailerUrl: "/Videos/unabatallatrasotra-trailer.mp4",
    posterUrl: "/unabatallatrasotra-poster.jpg",
    year: "2025"
  };

  // Todos los horarios en un solo array para facilitar la selección
  const allShowtimes = [
    "2:15 PM", "4:45 PM", "7:30 PM", "10:15 PM"
  ];
  ...
  const synopsis = [
    ...
    "Una épica historia de venganza y redención que lleva a los personajes a través de múltiples continentes, enfrentándose a peligros cada vez mayores mientras descubren que el pasado nunca está realmente enterrado.",
    "Con actuaciones estelares y secuencias de acción impresionantes, esta película redefine el género de thriller de acción con un toque de drama emocional."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            UNA BATALLA <span className="text-[#D4AF37]">TRAS OTRA</span>
          </h1>
