...
// Componente principal para Teléfono Negro 2 - MODERNIZADO
export default function TelefonoNegro2() {
  ...
  // Datos de la película Teléfono Negro 2
  const movieData = {
    title: "TELÉFONO NEGRO 2",
    originalTitle: "Black Phone 2",
    country: "United States of America",
    director: "Scott Derrickson",
    actors: "Ethan Hawke, Mason Thames, Madeleine McGraw, Demián Bichir, Miguel Mora, Jeremy Davies, Arianna Rivas",
    language: "Inglés",
    duration: "1h 56m",
    rating: "Mayores de 15 años",
    genres: ["Suspenso", "Terror", "Misterio"],
    imageUrl: "/telefononegro2.jpg",
    trailerUrl: "/Videos/telefononegro2-trailer.mp4",
    year: "2025"
  };
  ...
  const synopsis = [
    "Mientras Finn, ahora de 17 años, lucha por sobrellevar su vida después del cautiverio, Gwen, de 15 años, comienza a recibir llamadas en sus sueños a través del teléfono negro y a tener visiones inquietantes.",
    "Tres niños son acechados en un campamento de invierno conocido como Alpine Lake, donde las pesadillas se vuelven realidad y el pasado regresa para cobrar factura en esta escalofriante secuela."
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      {/* Patrón de textura sutil con tonos oscuros para suspenso */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,rgba(0,0,0,0.3),transparent_50%)] z-0"></div>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            TELÉFONO <span className="text-[#D4AF37]">NEGRO 2</span>
          </h1>
            ...
            <div className="relative group h-full">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-b from-black to-gray-900 h-full min-h-[500px] border border-white/10">
                ...
                <video 
                  ...
                  poster="/telefononegro2-poster.jpg"
                >
      ...
      {/* Efectos decorativos mejorados con tonos oscuros para suspenso */}
