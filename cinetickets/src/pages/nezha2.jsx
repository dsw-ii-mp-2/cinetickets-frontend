...
// Componente principal para Ne Zha 2 - MODERNIZADO
export default function NeZha2() {
  ...
  // Datos de la película Ne Zha 2 - CORREGIDO con nombres exactos
  const movieData = {
    title: "NE ZHA 2",
    originalTitle: "Nezha: Mo tong nao hai",
    country: "China",
    director: "Yu Yang",
    actors: "Yanting Lü, Mo Han",
    language: "Mandarín",
    duration: "1h 55m",
    rating: "Para todos los públicos",
    genres: ["Animación", "Aventura", "Fantasía", "Acción"],
    imageUrl: "/nezha2.jpg", // CORREGIDO
    trailerUrl: "/Videos/nezha2-trailer.mp4", // CORREGIDO
    posterUrl: "/nezha2-poster.jpg", // CORREGIDO
    year: "2025"
  };

  // Todos los horarios en un solo array para facilitar la selección
  const allShowtimes = [
    "11:30 AM", "2:00 PM", "4:45 PM", "7:15 PM"
  ];

  const synopsis = [
    "¡La película animada más taquillera de la historia llega a Colombia! Ne Zha, el niño demonio criado por humanos, forma una incómoda alianza con el príncipe Loong, Ao Bing, en una batalla épica para proteger a sus clanes.",
    "Cuando sus cuerpos se tambalean al borde de la destrucción, Ao Bing entra en el cuerpo de Ne Zha para no perecer. Mientras comparten cuerpo, Ne Zha debe embarcarse en una peligrosa búsqueda para obtener un elixir que restaure el cuerpo de Ao Bing.",
    "En esta aventura descubrirán una conspiración que desencadenará una guerra devastadora entre el bien y el mal, donde deberán enfrentarse a fuerzas oscuras que amenazan con destruir ambos mundos."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            NE <span className="text-[#D4AF37]">ZHA 2</span>
          </h1>
