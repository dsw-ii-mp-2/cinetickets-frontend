...
// Componente principal para Mascotas al Rescate - MODERNIZADO
export default function MascotasAlRescate() {
  ...
  // Datos de la película Mascotas al Rescate - CORREGIDO con posterUrl
  const movieData = {
    title: "MASCOTAS AL RESCATE",
    originalTitle: "Pets on a Train",
    country: "France, United States of America",
    director: "Benoît Daffis, Jean-Christian Tassy",
    actors: "Damien Ferrette, Hervé Jolly, Kaycie Chase",
    language: "Francés",
    duration: "1h 48m",
    rating: "Para todos los públicos",
    genres: ["Animación", "Aventura", "Comedia", "Familiar"],
    imageUrl: "/mascotasalrescate.jpg",
    trailerUrl: "/Videos/mascotasalrescate-trailer.mp4",
    posterUrl: "/mascotasalrescate-poster.jpg",
    year: "2025"
  };
  ...
  const synopsis = [
    "En un tren que está a punto de salir de la estación, suena la alarma que obliga a todos los pasajeros a bajarse. Pero entonces el tren arranca de manera improvista, llevándose a bordo los viajeros que no han tenido tiempo de bajar: los animales de compañía.",
    "Asombrados, estos descubren que el tren está bajo el control de Hans, un tejón manipulador y rencoroso, que se quiere vengar de Rex, el perro policía que le puso entre rejas hace años.",
    "Como los servicios de rescate no consiguen intervenir en el trayecto montañoso del tren, que circula a toda velocidad, los animales de compañía solo pueden contar con Falcon, un mapache un poco tramposo que hará todo lo posible para salvarles."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            MASCOTAS AL <span className="text-[#D4AF37]">RESCATE</span>
          </h1>
