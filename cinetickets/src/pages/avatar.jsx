...
// Componente principal para Avatar - MODERNIZADO
export default function Avatar() {
  ...
  // Datos de la película Avatar - CORREGIDO con posterUrl
  const movieData = {
    title: "AVATAR: EL CAMINO DEL AGUA",
    originalTitle: "Avatar: The Way of Water",
    country: "United States of America",
    director: "James Cameron",
    actors: "Zoe Saldaña, Sigourney Weaver, Sam Worthington, Stephen Lang, Cliff Curtis, Kate Winslet",
    language: "Inglés",
    duration: "3h 12m",
    rating: "PG-13 - Mayores de 13 años",
    genres: ["Ciencia Ficción", "Aventura", "Fantasía", "Acción"],
    imageUrl: "/avatar.jpg",
    trailerUrl: "/Videos/avatar-trailer.mp4",
    posterUrl: "/avatar-poster.jpg",
    year: "2022"
  };

  // Todos los horarios en un solo array para facilitar la selección
  const allShowtimes = [
    "1:30 PM", "3:45 PM", "6:15 PM", "9:30 PM"
  ];

  const synopsis = [
    "¡Este 2 de octubre AVATAR: EL CAMINO DEL AGUA regresa a los cines de todo el mundo únicamente en 3D y por una semana!",
    "Ambientada más de una década después de los sucesos que tuvieron lugar en la primera película, AVATAR: EL CAMINO DEL AGUA narra la historia de la familia Sully, el peligro que los persigue y los esfuerzos que hacen para mantenerse a salvo.",
    "Todo esto en los impresionantes paisajes marinos de Pandora, donde se encuentran nuevas culturas Na'vi y una variedad de criaturas marinas exóticas."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            AVATAR: <span className="text-[#D4AF37]">EL CAMINO DEL AGUA</span>
          </h1>
