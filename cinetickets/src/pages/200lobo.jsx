...
export default function Lobo200() {
  ...
  const movieData = {
    ...
    imageUrl: "/200lobo.jpg",
    trailerUrl: "/Videos/200lobo-trailer.mp4",
    posterUrl: "/200lobo-poster.jpg", // CORREGIDO: Ruta directa en public
    year: "2022"
  };
  ...
  const synopsis = [
    "Secuela de aventura animada de 100% lobo. Freddy Lupin, un valiente poodle con el corazón de un feroz lobo, tiene un solo objetivo: demostrar que el coraje no depende del pelaje.",
    "Pero cuando un desaje mal formulado lo transforma en un hombre lobo y pone en peligro el mundo mágico de las hadas, Freddy deberá unir fuerzas con aliados inesperados, enfrentarse a villanos peludos y redescubrir lo que realmente significa ser parte de una manada."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            200% <span className="text-[#D4AF37]">WOLF</span>
          </h1>
            ...
            <div className="relative group h-full">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-b from-black to-gray-900 h-full min-h-[500px] border border-white/10">
                ...
                <video 
                  ...
                  poster={movieData.posterUrl} // CORREGIDO: Usando la ruta correcta
                >
