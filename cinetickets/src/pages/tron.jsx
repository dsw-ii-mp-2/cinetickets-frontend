...
// Componente principal para Tron: Ares - MODERNIZADO
export default function TronAres() {
  ...
  // Datos de la película Tron: Ares
  const movieData = {
    title: "TRON: ARES",
    originalTitle: "Tron: Ares",
    country: "United States of America",
    director: "Joachim Rønning",
    actors: "Jared Leto, Greta Lee, Evan Peters, Hasan Minhaj, Jodie Turner-Smith",
    language: "Inglés",
    duration: "2h 15m",
    rating: "PG-13 - Mayores de 13 años",
    genres: ["Ciencia Ficción", "Acción", "Aventura"],
    imageUrl: "/tron.jpg",
    trailerUrl: "/Videos/tron-trailer.mp4",
    posterUrl: "/tron-poster.jpg",
    year: "2025"
  };
  ...
  const synopsis = [
    ...
    "Esta nueva entrega de la franquicia TRON explora los límites entre la realidad y el ciberespacio, llevando la acción a territorios nunca antes vistos.",
    "Ares deberá enfrentarse a desafíos imposibles mientras descubre los secretos que conectan ambos mundos en una batalla épica por la supervivencia."
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a0a0a] to-[#8B0000] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          >
            TRON: <span className="text-[#D4AF37]">ARES</span>
          </h1>
